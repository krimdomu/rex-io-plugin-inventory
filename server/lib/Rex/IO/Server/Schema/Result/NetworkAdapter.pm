...
__PACKAGE__->belongs_to( "hardware",
  "Rex::IO::Server::Schema::Result::Hardware",
  "hardware_id" );
__PACKAGE__->belongs_to( "bridge",
  "Rex::IO::Server::Schema::Result::NetworkBridge",
  "network_bridge_id" );

Rex::IO::Server::Schema::Result::Hardware->has_many(
  "network_adapters" => __PACKAGE__,
  "hardware_id"
);
